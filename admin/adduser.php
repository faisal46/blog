...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $mailquery = "select * from tbl_user WHERE email = '$email' limit 1 ";
    ...
    if ($mailcheck != false) {
         echo "<span class='error'>E-mail Already Exist !!</span>";
         ...
         if ($userInsert) {
            ...
            echo "<span class='error'>User Created Field !!</span>";
         }
    }
}
}
                    ...
                    <table class="form">					
                       <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <input type="text" name="password" placeholder="Enter Your Passwords..." class="medium" />
                            </td>
                        </tr>
                         <tr>
                            <td>
