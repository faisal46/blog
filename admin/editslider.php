...
<?php
if (!isset($_GET['editslidertid']) || $_GET['editslidertid'] == NULL) {
  echo "<script>window.location = 'sliderlist.php';</script>";
}else{
    $sliderid = $_GET['editslidertid'];
}
?>
        <div class="grid_10">
...
if (!empty($file_name)) {
    ...
    if ($file_size >1048567) {
     echo "<span class='error'>Slider image Size should be less then 1MB!
     </span>";
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                    <table class="form">                      
                        ...
                        <tr>
                            ...
                            <td> 
                                <img src="<?php echo $sliderresult['image']; ?>" height="50px" width="100px" /><br>
